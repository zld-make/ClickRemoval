...
if __name__ == "__main__":
    ...
    coord_path = "/path/to/your/coordinate.json"
    output_dir = "./out"
    ...
    model_path = "/mnt/nvme0n1/zld/BrushNet_data/ckpt/stable-diffusion-v1-5"
    ...
    def load_coordinates(json_path):
        ...
        formatted_points = [(point[0], point[1]) for point in points if len(point) == 2]
        return formatted_points, labels

    attn_aggregator = StableDiffusion1AttentionAggregator(device='cuda:0')
