...
class InferenceDataset(Dataset):
    def __init__(self, datadir, inference_dir, test_scene, clip_preprocess, eval_resolution=512, img_suffix='.jpg', inpainted_suffix='_removed.png'):
...
if __name__ == "__main__":
    ...
    dataset = InferenceDataset(args.datadir, args.inference_dir, args.test_scene, clip_metric.preprocess ,eval_resolution=512, img_suffix='.png', inpainted_suffix=args.inpainted_suffix)
